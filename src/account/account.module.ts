...
const withdrawAccountSerive = new WithdrawAccountService(mapAccountRepositoryService);

export const accountService = new AccountService(createAccountService, depositAccountService, withdrawAccountSerive);
...
const withdrawAccountRestService = new WithdrawAccountRestService(accountService);
export const accountRestController = new AccountRestController(createAccountRestService, depositAccountRestService, withdrawAccountRestService);
