...
import { WithdrawAccountServiceParamsDTO, WithdrawAccountServiceResponseDTO } from "./withdraw.account.service";
...
export class WithdrawAccountService {
    ...
    async execute(params: Params): Promise<Response> {
      ...
      if (account.balance < params.data.withdrawValue) throw new Error("Balance insuficient")
