...
import { WithdrawAccountServiceParamsDTO, WithdrawAccountServiceResponseDTO } from "../withdraw/withdraw.account.service";
...
export class AccountService {
    ...
    async withdraw(params: WithdrawAccountServiceParamsDTO): Promise<WithdrawAccountServiceResponseDTO> {
